    ...
    <div className="flex justify-center items-center pt-8">
      <div className="flex flex-col max-w-md p-6 rounded-md border sm:p-10 bg-gray-100 text-gray-900">
        <div className="mb-8 text-center">
          <h1 className="my-3 text-4xl text-purple-600 font-bold">Sign in</h1>
        ...
        <div className="space-y-1">
          <button className="text-xs hover:underline text-gray-600">
            Forgot password?
          </button>
        </div>
        ...
        <p className="px-6 text-sm text-center text-gray-600">
          ...
          <Link to="/resister" className="hover:underline text-purple-600">
            Sign up
          </Link>
          .
        </p>
