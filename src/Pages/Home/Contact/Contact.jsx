      ...
      <div>
        <div className="container my-24 px-6 mx-auto">
          <section className="mb-32 text-gray-800">
            <h1 className="text-5xl text-purple-600 font-bold text-center">
              Contact Us
            </h1>
            ...
            "
                      ...
                      <button
                        type="submit"
                        className="
                      inline-block w-full rounded bg-purple-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500  "
                      >
                        Send
                      </button>
                    </form>
